...
const form = read("renbo-mfg-frontend/views/inventory/form.ejs");
...
const formScript = read("renbo-mfg-frontend/public/js/inventory-form.js");
...
const countView = read("renbo-mfg-frontend/views/inventory/stock-opname-count.ejs");
const countScript = read("renbo-mfg-frontend/public/js/stock-opname-count.js");
...
const operations = read("renbo-mfg-frontend/public/js/operations-detail.js");
