...
const frontendRoot = fs.existsSync(path.join(root, "../renbo-mfg-frontend")) ? "../renbo-mfg-frontend" : "../frontend";
const editor = fs.readFileSync(path.join(root, frontendRoot, "public/js/bom-table-editor.js"), "utf8");
