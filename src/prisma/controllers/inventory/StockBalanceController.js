...
// ============================================
// Public balances are projections of approved business transactions.
// Manual entry, overwrite or hiding balances would bypass supervisor approval.
const requireApprovedStockOpname = (_req, res) => res.status(409).json({
  code: "STOCK_OPNAME_APPROVAL_REQUIRED",
  message: "Perubahan saldo manual wajib melalui Stock Opname dengan approval supervisor. Gunakan pengaturan policy untuk batas stok saja.",
  actionUrl: "/modules/inventory/stock-opname",
});
exports.upsert = requireApprovedStockOpname;
exports.adjust = requireApprovedStockOpname;
exports.updatePolicy = require("../../services/inventory/stockBalancePolicyService").createPolicyController(prisma);
...
// ============================================
exports.remove = requireApprovedStockOpname;
