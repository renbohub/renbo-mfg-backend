...
router.post("/goods-receipts/:grNumber/release-without-qc", authorize("purchaseOrder", "approve"), logger("goods-receipt", "release-without-qc"), ctrl.releaseWithoutInspection);
