...
router.patch("/:stoNo/found-stock", authorize("stockOpname", "update"), logger("stockOpname", "found-stock"), ctrl.foundStock);
...
router.patch("/:stoNo/check", authorize("stockOpname", "approve"), logger("stockOpname", "check"), ctrl.check);
...
router.get("/:stoNo/adjust-preview", authorize("stockOpname", "read"), ctrl.previewAdjustment);
